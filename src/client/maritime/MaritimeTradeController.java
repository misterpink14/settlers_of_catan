...
public class MaritimeTradeController extends Controller implements IMaritimeTradeController {
	...
	public void startTrade() {
		...
		int pID = ClientFacade.getInstance().getUserData().getPlayerIndex();
		int brickRatio = ClientFacade.getInstance().game.getMaritimeTradeRatio(pID, ResourceType.BRICK);
		int woodRatio = ClientFacade.getInstance().game.getMaritimeTradeRatio(pID, ResourceType.WOOD);
		int wheatRatio = ClientFacade.getInstance().game.getMaritimeTradeRatio(pID, ResourceType.WHEAT);
		int oreRatio = ClientFacade.getInstance().game.getMaritimeTradeRatio(pID, ResourceType.ORE);
		int sheepRatio = ClientFacade.getInstance().game.getMaritimeTradeRatio(pID, ResourceType.SHEEP);
